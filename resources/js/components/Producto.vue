                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Job Find</h5>
                                            <p class="m-b-0">Fill Below Form &amp; Find Your Job</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Job Find</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-primary">
                                                                        ...
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Enter email address</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Reference Number</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-4 m-b-5">
                                                                    <div class="form-group form-primary">
                                                                        <select name="select" class="form-control ">
                                                                            ...
                                                                            <option value="opt8" />8
                                                                            <option value="opt9" />9
                                                                            <option value="opt10" />10
                                                                            <option value="opt11" />11
                                                                            <option value="opt11" />12
                                                                            <option value="opt12" />13
                                                                            <option value="opt12" />14
                                                                            <option value="opt12" />15
                                                                            <option value="opt12" />16
                                                                            <option value="opt12" />17
                                                                            <option value="opt12" />18
                                                                            <option value="opt12" />19
                                                                            <option value="opt12" />20
                                                                            <option value="opt12" />21
                                                                            <option value="opt12" />22
                                                                            <option value="opt12" />23
                                                                            <option value="opt12" />24
                                                                            <option value="opt30" />25
                                                                            <option value="opt30" />26
                                                                            <option value="opt30" />27
                                                                            <option value="opt30" />28
                                                                            <option value="opt30" />29
                                                                            <option value="opt30" />30
                                                                        </select>
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-primary">
                                                                        ...
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Your Full Address</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 m-b-5">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">School Name</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Specialization</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-6 m-b-5">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Degree</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Post Graduation</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-6 m-b-5">
                                                                    <label class="col-lable">Post Graduation</label>
                                                                    <div class="form-group form-primary">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <label class="col-lable">End Education on</label>
                                                                    <div class="form-group form-primary">
                                                                        <input type="date" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                        ...
                                                        <form action="#" class="form-material" />
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 m-b-5">
                                                                    <label class="col-lable">Starting Duration</label>
                                                                    <div class="form-group form-primary">
                                                                        <input type="date" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <label class="col-lable">End Education</label>
                                                                    <div class="form-group form-primary">
                                                                        <input type="date" class="form-control" required="" />
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <label class="col-lable">Upload File</label>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-primary">
                                                                        <select class="form-control ">
                                                                            <option />Where did you find us?
                                                                            <option />Google Plus
                                                                            <option />Linkedin
                                                                            <option />Google Awards
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-primary">
                                                                        <textarea class="form-control" required=""></textarea>
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Any queries .. ??</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
