                    ...
                    <div class="card">
                        ...
                        <div class="card-block icon-btn">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" autocomplete="off" v-model="buscar" v-on:keyup="listarTipo(1,buscar)" @keyup.enter="listarTipo(1,buscar)" placeholder="Texto a buscar" class="form-control" />
                              </div>
                              <div class="col-sm-4">
